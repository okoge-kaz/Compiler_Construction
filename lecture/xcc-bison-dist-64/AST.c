...
create_AST(char *ast_type, int argp_len, ...) {
    ...
    if (!strcmp(ast_type, "AST_IDENTIFIER") || !strcmp(ast_type, "AST_expression_string")) {
        ast->num_child = 0;
        ast->child = NULL;
    ...
    } else if (!strcmp(ast_type, "AST_expression_int") || !strcmp(ast_type, "AST_expression_char") || !strcmp(ast_type, "AST_expression_long")) {
        ast->num_child = 0;
        ast->child = NULL;
